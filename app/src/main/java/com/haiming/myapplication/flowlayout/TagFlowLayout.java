    ...
    public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
        ...
        public void delete(List<Integer> delete){
            ...
            for (Integer integer : delete){
                TagView tagView = (TagView) getChildAt(integer);
//                tagView.getTagView().setSelected(false);

                if(tagView != null){
                    setChildUnChecked(integer, tagView);
...
//                tagView.setChecked(false);
    ...
    public void setMax(TagFlowLayout.max max) {
        this.max = max;
    }
